...
import ru.vtb.testing.OpenwayVTBCard;
...
public class OpenwayVTBCardTest extends BaseTest {
    ...
    public void checkPageInformation() {
        OpenwayVTBCard openwayVTBCard = new OpenwayVTBCard(driver);
        openwayVTBCard.pageInformation();
    }
    ...
    public void checkButtonDownLoad() {
        OpenwayVTBCard openwayVTBCard = new OpenwayVTBCard(driver);
        openwayVTBCard.checkButtonDownLoad();
    }
    ...
    public void checkButtonSend() {
        OpenwayVTBCard openwayVTBCard = new OpenwayVTBCard(driver);
        openwayVTBCard.checkButtonSend();
    }
    ...
    public void checkButtonPrint() {
        OpenwayVTBCard openwayVTBCard = new OpenwayVTBCard(driver);
        openwayVTBCard.checkButtonPrint();
    }
